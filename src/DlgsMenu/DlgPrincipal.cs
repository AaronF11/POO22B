        ...
        public void ChangeColorTheme(int CodeColor)
        {
            ...
            switch (CodeColor)
            {
                case 0:
                    ...
                    ButtonsBackground = Color.FromArgb(2, 242, 255);
                    SubMenuBackground = Color.WhiteSmoke;
                    PtbLogoMenu.BackgroundImage = Properties.Resources.Logo2;
                ...
                case 1:
                    ...
                    ButtonsBackground = Color.FromArgb(17, 16, 70);
                ...
                case 2:
                    //Definición de colores y recursos
                    Background = Color.FromArgb(49, 193, 230);
                    Letters = Color.FromArgb(17, 16, 29);
                    ButtonsBackground = Color.FromArgb(2, 242, 255);
                    SubMenuBackground = Color.FromArgb(49, 193, 230);
                    PtbLogoMenu.BackgroundImage = Properties.Resources.Logo;
                    //Asignación a componentes
                    this.BackColor = Background;
                    BtnPracticesMenu.ForeColor = Letters;
                    BtnToolsMenu.ForeColor = Letters;
