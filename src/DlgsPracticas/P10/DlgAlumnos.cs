...
{
    public partial class DlgAlumnos : Form
    {
        //---------------------------------------------------------------------
        //Atributos.
        //---------------------------------------------------------------------
        ...
        {
            @base.Insert_Into(2, Dgv, TxtId, TxtName, TxtLastname, TxtAge, TxtMail, null);
        }

        private void BtnUpdate_Click(object sender, EventArgs e)
        {
            @base.Update(2, Dgv, TxtId, TxtName, TxtLastname, TxtAge, TxtMail, null);
        }

        private void BtnDelete_Click(object sender, EventArgs e)
        {
            @base.Delete(2, Dgv, TxtId, TxtName, TxtLastname, TxtAge, TxtMail, null);
        }
    }
}
