...
namespace POO22B_FPA.src.Class
{
    ...
    //FPA. 08/09/22.
    //---------------------------------------------------------------------
    public partial class CMeta : UserControl
    {
        //---------------------------------------------------------------------
        //Atributos.
        //---------------------------------------------------------------------
                ...
                while (true)
                {
                    if (Encendido)
                    {
                        ...
                        if (X <= 0)
                        {
                            ...
                            Image.FromFile(@"C:\Users\aaron\source\repos\POO22B_FPA\Resources\Este.png");
                        }
                        ...
                        if (X >= Area.Width - Width)
                        {
                            Este = false;
                            Oeste = true;
                            Image.FromFile(@"C:\Users\aaron\source\repos\POO22B_FPA\Resources\Oeste.png");
                        }
                ...
                while (true)
                {
                    if (Encendido)
                    {
                        ...
                        if (Y <= 0)
                        {
                            ...
                            Image.FromFile(@"C:\Users\aaron\source\repos\POO22B_FPA\Resources\Sur.png");
                        }
                        ...
                        if (Y >= Area.Height - Height)
                        {
                            Sur = false;
                            Norte = true;
                            Image.FromFile(@"C:\Users\aaron\source\repos\POO22B_FPA\Resources\Norte.png");
                        }
